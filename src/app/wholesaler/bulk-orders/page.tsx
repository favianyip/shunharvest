      ...
      <section className="bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="font-serif text-4xl md:text-5xl text-white">Bulk Orders</h1>
          </div>
          <p className="text-xl text-stone-300 max-w-2xl font-light">
            Large quantity orders for restaurants, hotels, supermarkets, and retail businesses.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-stone-100">
            <h2 className="font-serif text-2xl text-stone-900 mb-6">What We Offer</h2>
            <ul className="space-y-4 mb-8">
              {[
                'Minimum order quantity: 50kg per shipment',
                'Weekly and bi-weekly delivery schedules',
